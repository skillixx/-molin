    ...
    <div class="page-container chat-layout">
      <aside class="conversation-panel glass-card">
        <div class="panel-header">
          <div>
            <strong>历史会话</strong>
            <small>{{ currentAgentConversations.length }} 条</small>
          </div>
      ...
      <div class="chat-main">
        <section class="chat-header glass-card" v-loading="loading">
          <div class="header-left">
            <el-button class="chat-toolbar-button back-button" :icon="ArrowLeft" text @click="router.push('/agents')">返回工作台</el-button>
            <div>
          ...
          <div class="header-right">
            ...
            <el-button class="chat-toolbar-button" :icon="Refresh" @click="fetchAgent">刷新</el-button>
          </div>
        </section>
