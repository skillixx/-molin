    ...
    // 后台布局（需要登录）
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { requiresAuth: true, requiresAdminVerify: true, title: '用户资产', permission: 'asset:view' },
        },
        {
          path: 'memberships',
          name: 'MembershipManage',
          component: () => import('@/views/membership/MembershipManageView.vue'),
          meta: { requiresAuth: true, requiresAdminVerify: true, title: '会员管理', permission: 'membership:view' },
        },
        {
          path: 'apps',
          name: 'AppManage',
        ...
        },
        {
          ...
          meta: { requiresAuth: true, requiresAdminVerify: true, title: '内容管理', permission: 'content:manage' },
        },
      ],
    },
    // 404 重定向
