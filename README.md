...
- 已开始准备 `CHG-G8-TEST-READONLY-STAGING-EVIDENCE-20260812-006` 仓库候选：冻结 004 的竞态安全暂存读取算法，并为身份、machine-id、部署根路径/元数据、暂存查找和父路径漂移提供固定低敏门禁枚举。当前仅允许本地开发和测试；完成独立评审、QA、产品、精确 HEAD CI 与 merge commit 并再次获得用户授权前，禁止连接测试服。
