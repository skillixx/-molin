...
- `CHG-G8-TEST-READONLY-ACCESS-20260812-003` 当前仅在本地重新冻结候选和单次 SSH 包装器：来源提交 `8ec87857`、来源树、三项制品摘要、部署根和 Go 1.26.5 双构建已绑定，本地回执为 `82b18d6040bcd6be72cf170fa066ecd7cf469a53f4901365f379bec5a89c496d`。包装器消除 `cut`/嵌套引号并保证失败零重试；精确 PR HEAD 的 CI、独立验收和用户安装授权尚未完成，禁止连接、上传或安装。测试服运行态 P1 与 UNKNOWN 仍未关闭。
