...
- 009 Drop 只读入口安装候选正在进行仓库工程门禁：ChangeId `CHG-G8-TEST-READONLY-ACCESS-DROP-20260813-009`，冻结来源 `7f3325e2d6801567fea34a2049a2f3ada114e348`、源码树 `4563feb59850dca87789adfb5eea820f78b1a209` 和本地回执 `840bdbed48edab6d70d351fa232b7426903bf3f3098f682e2884f513b9cd0efd`。候选只绑定 Drop SSH 端点，不含物理 hostname/machine-id；当前为 `PENDING_ENGINEERING_GATES_AND_USER_APPROVAL`，尚未连接、上传或安装测试服务。
