...
- G7 可靠性验收正在推进：当前工作树已补齐 AI 专属指标、Prometheus 告警、Grafana SLO、只读账单核对、100 并发、幂等、流式断连、Fake 上游/Redis 混沌与安全测试；本地隔离三项差额和四类异常均为 0。测试环境、CI、独立评审、QA、产品验收和 PR 合并未完成前不得声明 G7 完成，证据见 `docs/ai-gateway-g7-acceptance.md`。
