...
- PR #379 已按 merge commit `97ee6037cafa90577be619fc67e78866c4d75efe` 归档 014 结果并关闭重放入口，远端结果分支已删除。新的 015 工程候选只准备从已证明完整的 011 暂存安装 root-owned 最小只读审计/对账入口；当前状态为 `PENDING_ENGINEERING_REVIEW / REMOTE_NOT_AUTHORIZED`，尚未运行 SSH、sudo 或安装。工程候选、固定影响、回滚和再次授权要求见 `docs/ai-gateway-g8-test-readonly-access-install-authorization-20260814-015.md`。
