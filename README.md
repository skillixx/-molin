...
| 阿里云短信验证码阶段 2（模板同步、场景绑定、9 个管理 API 与安全测试发送） | `modules/sms/`、`modules/auth/`、`modules/iam/`、`server/migrations/000059*` | 🧪 本地代码与 Go 回归通过；等待 MySQL 8 迁移矩阵、QA/PM、远程 CI 及另行授权的真实验证 |
