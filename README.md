...
- G5 正在开发 AI 网关管理工作台：模型发布、人民币价格版本、Bifrost 路由、安全/资源/预算/异常统一入口及 Migration `000064`。本地实现状态见 `docs/ai-gateway-g5-acceptance.md`；PR、测试环境部署、真实 E2E 和 QA/产品确认未完成前不得标记 G5 完成。
