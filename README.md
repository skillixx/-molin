...
- `CHG-G8-TEST-READONLY-ACCESS-20260812-002` 本地安装候选已完成仓库门禁：PR #336 精确 HEAD `91c2bd9e70774319f67436c8b545bc57181f5aa8` 的 CI run `31573880151` 为 9/9 SUCCESS，独立代码安全、QA 和产品/规格均为 P0/P1/P2=0，并按 merge commit 合并为 `4f3691e12cfb93a79f25e587f55dd32ccaf7ed38`，远端功能分支已删除。候选绑定来源提交 `50b3e2f9`、来源树、三项制品摘要、部署根目录 `/home/pc/molin` 和 Go 1.26.5 双构建；尚未连接、上传或安装测试服，也未修改 sudoers。独立安装授权清单仍待用户再次确认，测试服运行态 P1 与 UNKNOWN 尚未关闭。
