...
- G6 正在开发用户端模型市场与完整客户旅程：已实现发布快照目录、人民币价格、文档健康状态、Project/平台 SK、快速接入、用量账本、CSV 导出和账单申诉；当前仅代表本地代码与自动化测试范围，测试环境部署、真实 Bifrost 对账、独立 QA/产品双签和 PR 合并仍以 `docs/ai-gateway-g6-acceptance.md` 为准。
