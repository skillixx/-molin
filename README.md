...
- `CHG-G8-TEST-READONLY-ACCESS-20260812-002` 当前仅获批准备本地候选：已绑定来源提交 `50b3e2f9`、来源树、三项制品摘要和 Go 1.26.5 双构建，本地五文件白名单与 `SHA256SUMS` 通过；尚未连接、上传或安装测试服，也未修改 sudoers。独立安装授权清单仍待候选 PR 精确 HEAD 的评审、QA、产品和 CI 全绿后由用户再次确认。
