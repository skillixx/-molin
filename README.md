...
- 012 Drop 暂存只读取证的仓库工程门禁与合并已完成：PR #369 最终 HEAD `6823a6be77c77290732a417935c85af4d213f708` 经 CI run `31697655486` 12/12 SUCCESS 及独立代码安全、QA、产品/规格 P0/P1/P2=0 后，以 merge commit `247c637c2b5bce82377ce1ad1431b4b520187068` 合入主干。用户批准后唯一一次 local-check 返回固定低敏 `evidence_unavailable`、退出码 2、stderr 为空，随即零重试停止；SSH 为 `0/1`，未连接测试服，未形成远端三态证据，011 暂存继续为 `UNKNOWN`。012 已消费并在参数解析、身份材料读取和联网前失败关闭；继续取证必须使用新 ChangeId 和独立授权，见 `docs/ai-gateway-g8-test-readonly-drop-staging-evidence-attempt-20260813-012.md`。
