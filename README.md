...
- `CHG-G8-TEST-READONLY-STAGING-EVIDENCE-20260812-004` 已完成 PR #341、CI 12/12、独立安全/QA/产品验收并以 merge commit `7e27e88b1c4b63630a0be346e41226c449d033e4` 合并；只允许在用户再次批准后执行一次固定 SSH，核对主机、部署根、003 暂存路径、五文件白名单、类型、属主、权限、大小和冻结摘要。当前尚未取得远端执行授权、未再次连接测试服；不得下载、删除、sudo、读取业务数据或顺带安装。授权清单见 `docs/ai-gateway-g8-test-readonly-staging-evidence-authorization-20260812-004.md`。
