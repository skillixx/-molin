...
- 009 Drop 只读入口安装候选的仓库工程门禁已完成：ChangeId `CHG-G8-TEST-READONLY-ACCESS-DROP-20260813-009`，冻结来源 `7f3325e2d6801567fea34a2049a2f3ada114e348`、源码树 `4563feb59850dca87789adfb5eea820f78b1a209` 和本地回执 `840bdbed48edab6d70d351fa232b7426903bf3f3098f682e2884f513b9cd0efd`。PR #358 精确 HEAD `2efb809ba090c9af780d8c6be2f75ee707b92d6b` 经 CI run `31665135810` 12/12 SUCCESS 及独立代码安全、QA、产品/规格 P0/P1/P2=0 后，以 merge commit `1f0c2d11dc705be9496eb18c73688d21ee0e8ab5` 合入主干。用户批准后，唯一一次 `--local-check` PASS；唯一正式调用在 Windows 冻结私钥副本的 NTFS ACL 校验处以 `invalid_request`、退出码 2 停止，离线最小复现确认固定 `ssh-keygen -y` 因副本权限退出 255，失败发生在 SSH/SFTP 调用之前。未连接测试服务、未上传、未进入 root 通道、未安装或执行 sudo self-test；009 已消费并禁止重放。消费证据 HEAD `bab8f89a317f9bcb7ca1fd1f534f3fa6a9545f49` 经 CI run `31667550392` 12/12 SUCCESS 及独立代码安全、QA、产品/规格 P0/P1/P2=0 后，由 PR #360 按 merge commit `c9402d94129da4042e3fb1bb978d63018af4a439` 合入主干。继续必须使用新 ChangeId 修复并验证 Windows 私钥冻结契约，证据见 `docs/ai-gateway-g8-test-readonly-access-attempt-20260813-009.md`。
