...
- 010 Drop 直连候选正在完成仓库工程门禁：ChangeId `CHG-G8-TEST-READONLY-ACCESS-DROP-20260813-010`，冻结来源 `75b1fc4ddb7138495547cec03fa948648de337d7`、源码树 `53ba990318bc1a036b442d88ff8133d776a453dc`，Windows 五文件回执 `3ff8cf3ad7237f866f83305d00ab73f766381b7f3247abee915efee629e41fb0`。方案显式使用现有 ED25519 密钥免密码认证，不复制或修改私钥 ACL；SSH/SFTP 仍须等待独立用户授权。本条仅表示仓库候选开发中，不表示已连接、上传或安装；见 `docs/ai-gateway-g8-test-readonly-access-install-authorization-20260813-010.md`。
