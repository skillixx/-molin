...
- `CHG-G8-TEST-READONLY-STAGING-EVIDENCE-20260812-006` 仓库候选已通过 PR #345 精确 HEAD `2d55021d5497528303d69cb1e01b8feaf5098cad`、CI run `31609801571` 12/12、独立代码安全/QA/产品 P0/P1/P2=0，并以 merge commit `df7d64102f7a358b6109d39d05bbbe92c00302d9` 合入主干。候选冻结 004 的竞态安全暂存读取算法，并提供固定低敏门禁枚举；当前仅为 `PENDING_USER_APPROVAL`，尚未执行 006，禁止把工程合并当作连接授权或暂存 UNKNOWN 已关闭。
