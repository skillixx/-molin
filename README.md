...
- G6 用户端模型市场与完整客户旅程已完成代码、测试环境真实 Bifrost 对账、真实浏览器、CI 和独立 QA：覆盖发布快照目录、人民币价格、静态文档、Project/平台 SK、快速接入、用量账本、CSV 和账单申诉。当前仍在产品整改复验和 PR 合并门禁中，不代表生产开放；最终状态以 `docs/ai-gateway-g6-acceptance.md` 为准。
