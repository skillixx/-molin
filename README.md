...
- 012 Drop 暂存只读取证的仓库工程门禁与合并已完成：PR #369 最终 HEAD `6823a6be77c77290732a417935c85af4d213f708` 经 CI run `31697655486` 12/12 SUCCESS 及独立代码安全、QA、产品/规格 P0/P1/P2=0 后，以 merge commit `247c637c2b5bce82377ce1ad1431b4b520187068` 合入主干。ChangeId `CHG-G8-TEST-READONLY-STAGING-EVIDENCE-DROP-20260813-012` 只面向固定 011 暂存；当前状态为 `PENDING_USER_APPROVAL`，尚未运行 local-check、尚未连接测试服。工程合并不构成远端执行、清理、安装或生产授权，授权边界见 `docs/ai-gateway-g8-test-readonly-drop-staging-evidence-authorization-20260813-012.md`。
