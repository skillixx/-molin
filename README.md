...
- 021 使用独立 ChangeId `CHG-G8-TEST-READONLY-RUNTIME-AUDIT-DROP-20260815-021` 修复 020 的仓库外启动包装缺口：工程 HEAD `c73ef139721bcfc693ffb31caa6fe803be526286` 经 PR #398、CI run `31867790659 completed/success` 和独立评审后，以 merge commit `8bc05cbf3bc71a8954087dc7f26732f836e5212e` 合入 main；合并后原始 blob、LF 与 32009 字节冻结命令摘要均已复核无漂移。当前为 `PENDING_USER_APPROVAL / REMOTE_NOT_AUTHORIZED`，尚未执行、尚未消费，不授权 SSH、测试服 Docker、HTTP、数据库、sudo、安装、业务、上游或费用动作，`G8_SOFTWARE_CLOSED_LOOP` 仍未完成。见 `docs/ai-gateway-g8-test-readonly-runtime-audit-authorization-20260815-021.md`。
