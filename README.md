...
- 010 Drop 直连候选的仓库工程门禁已完成：ChangeId `CHG-G8-TEST-READONLY-ACCESS-DROP-20260813-010`，冻结来源 `75b1fc4ddb7138495547cec03fa948648de337d7`、源码树 `53ba990318bc1a036b442d88ff8133d776a453dc`，Windows 五文件回执 `3ff8cf3ad7237f866f83305d00ab73f766381b7f3247abee915efee629e41fb0`。方案显式使用现有 ED25519 密钥免密码认证，不复制或修改私钥 ACL。PR #362 精确 HEAD `b47e94780a2ac884a7d2dccb0d1f80abb8b137cd` 经 CI run `31673893162` 12/12 SUCCESS 及独立代码安全、QA、产品/规格 P0/P1/P2=0 后，以 merge commit `a890cdff2793a141f7b377aa74d0996d57e13cbd` 合入主干。安装清单现为 `PENDING_USER_APPROVAL`；本次合并未运行 010 本地检查、SSH、SFTP、root 安装或 sudo self-test，也不构成测试服安装授权；见 `docs/ai-gateway-g8-test-readonly-access-install-authorization-20260813-010.md`。
