#!/usr/bin/env python3
"""验证已消费的 022 生成入口不会解析历史参数或触达外部进程。"""
...
class ConsumedReadonlyRuntimeAudit022CommandTests(unittest.TestCase):
        ...
        for arguments in invocations:
            with self.subTest(arguments=arguments):
                ...
                self.assertEqual(
                    ...
                    (2, "G8_TEST_READONLY_RUNTIME_AUDIT_022_COMMAND=FAILED reason=change_id_consumed\n", ""),
                )
