...
echo "IMAGE_G2_MYSQL_MIGRATION=PASS mysql=8.0.46 full_chain_1_to_69=true legacy_chat=true image_checks=true down_retained=true reup=true quote_concurrency=100_one_winner project_database=false provider_calls=0 wallet_writes=0"
