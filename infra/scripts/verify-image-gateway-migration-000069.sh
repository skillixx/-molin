...
apply_file "000070_expand_image_task_asset_repository.up.sql" >/dev/null
apply_file "000071_expand_image_billing_adjustments.up.sql" >/dev/null
...
echo "IMAGE_G2_MYSQL_MIGRATION=PASS mysql=8.0.46 full_chain_1_to_69=true current_head_compat_72_74_75_76=true current_head_compat_77=true legacy_chat=true image_checks=true down_retained=true reup=true quote_concurrency=100_one_winner project_database=false provider_calls=0 wallet_writes=0"
