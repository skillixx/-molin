...
g3_up="${repo_root}/server/migrations/000061_create_ai_gateway_g3_billing.up.sql"
g3_down="${repo_root}/server/migrations/000061_create_ai_gateway_g3_billing.down.sql"
