...
class ConsumedStagingEvidence013Tests(unittest.TestCase):
    def test_every_invocation_fails_before_parser_materials_and_network(self):
        spec = importlib.util.spec_from_file_location("g8_staging_evidence_013_consumed", SCRIPT_PATH)
        ...
        self.assertEqual(
            stdout.getvalue(),
            "G8_TEST_READONLY_DROP_STAGING_EVIDENCE_013=FAILED reason=change_id_consumed\n",
        )
