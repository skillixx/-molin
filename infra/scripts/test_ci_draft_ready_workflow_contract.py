...
class CIDraftReadyWorkflowContractTest(unittest.TestCase):
    ...
    def test_g8_windows_job_covers_015_through_023_tombstones_and_024_candidate(self):
        """原生 Windows 门禁必须覆盖 015 至 023 墓碑和 024 候选。"""
        ...
        self.assertIn("test_run_ai_gateway_g8_test_readonly_ssh_diagnostic_024.py", block)
        self.assertIn("test_ai_gateway_g8_readonly_ssh_diagnostic_024_authorization_contract.py", block)
    ...
    def test_g8_ready_job_runs_015_through_023_tombstones_and_024_in_host_and_network_none(self):
        """Linux 门禁必须覆盖 015 至 023 墓碑和 024 断网回归。"""
        ...
        self.assertGreaterEqual(block.count("test_run_ai_gateway_g8_test_readonly_ssh_diagnostic_024.py"), 2)
        self.assertGreaterEqual(block.count("test_ai_gateway_g8_readonly_ssh_diagnostic_024_authorization_contract.py"), 2)
        self.assertNotIn("g8-test-readonly-access-install-020.sh", block)
        self.assertNotIn("test_g8_test_readonly_access_install_020.py", block)
        self.assertIn("验证 G8 015/016/017/018/019/020/021/022/023 墓碑与 024 候选离线门禁", block)
        ...
        self.assertIn("test_run_ai_gateway_g8_test_readonly_ssh_diagnostic_024.py", bookworm_network_none)
        self.assertIn("test_ai_gateway_g8_readonly_ssh_diagnostic_024_authorization_contract.py", bookworm_network_none)
