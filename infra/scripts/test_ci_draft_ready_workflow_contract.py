...
class CIDraftReadyWorkflowContractTest(unittest.TestCase):
    ...
    def test_g8_windows_job_covers_trusted_paths_and_consumed_entry(self):
        """原生 Windows 门禁必须覆盖可信路径、015 至 019 墓碑与 020 候选。"""
        ...
        self.assertIn("test_g8_test_readonly_access_install_020.py", block)
        self.assertIn("test_prepare_ai_gateway_g8_test_readonly_access_020_command.py", block)
        self.assertIn("test_prepare_ai_gateway_g8_test_readonly_access_020_security_controls.py", block)
        self.assertIn("test_ai_gateway_g8_readonly_install_020_authorization_contract.py", block)
    ...
    def test_g8_ready_job_runs_consumed_tombstones_and_020_in_host_and_network_none(self):
        """Linux 门禁必须覆盖 015 至 019 历史墓碑、020 候选与断网回归。"""
        ...
        self.assertIn("bash -n infra/scripts/g8-test-readonly-access-install-020.sh", block)
        self.assertGreaterEqual(block.count("test_g8_test_readonly_access_install_020.py"), 2)
        self.assertGreaterEqual(block.count("test_prepare_ai_gateway_g8_test_readonly_access_020_command.py"), 2)
        self.assertGreaterEqual(block.count("test_prepare_ai_gateway_g8_test_readonly_access_020_security_controls.py"), 2)
        self.assertGreaterEqual(block.count("test_ai_gateway_g8_readonly_install_020_authorization_contract.py"), 2)
        self.assertIn("验证 G8 015/016/017/018/019 墓碑与 020 候选离线门禁", block)
        self.assertIn(
        ...
        self.assertIn("test_g8_test_readonly_access_install_020.py", bookworm_network_none)
        self.assertIn("test_prepare_ai_gateway_g8_test_readonly_access_020_command.py", bookworm_network_none)
        self.assertIn("test_prepare_ai_gateway_g8_test_readonly_access_020_security_controls.py", bookworm_network_none)
