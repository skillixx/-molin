...
- 用户已批准仅准备 `CHG-G8-TEST-READONLY-ACCESS-20260812-002` 本地候选，并指定阿里云控制台 root 通道；本轮禁止连接测试服务器。候选绑定来源提交 `50b3e2f9d18b38e7d4a91ebeb4f03c413ef33c44`、来源树 `73fb652a1f86db84991c8745f8c10e1d2a255f29`、部署根目录 `/home/pc/molin`、审计器/对账器/sudoers 摘要和 Go 1.26.5 双构建，本地五文件白名单及 `SHA256SUMS` 回执 `d6d07f7b4959e48f5ffe0e92ee4116cef55fe56f5318df6ae3f0d9c5350ee567` 已通过。两份中间候选已标记废弃并禁止上传；最终实现同时保持 001 历史复现清单语义不漂移。PR #336 精确 HEAD `91c2bd9e70774319f67436c8b545bc57181f5aa8` 的 CI run `31573880151` 为 9/9 SUCCESS，独立代码安全、QA 和产品/规格均为 P0/P1/P2=0，并按 merge commit 合并为 `4f3691e12cfb93a79f25e587f55dd32ccaf7ed38`，远端功能分支已删除。上述事实仅证明本地候选和仓库门禁通过；独立安装授权仍待用户确认，尚未连接、上传或安装测试服，也未修改 sudoers，测试服 P1 与 UNKNOWN 均未关闭。
