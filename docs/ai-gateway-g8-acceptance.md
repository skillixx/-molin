...
- `CHG-G8-TEST-READONLY-ACCESS-20260812-003` 已完成本地候选与预检包装器工程门禁：候选绑定来源提交 `8ec878572f62ef2584c38aaadc1bca1cb802b13f`、来源树 `988bdcdc8017322264733ebe68876e4811b01412`、部署根、三项制品摘要和 Go 1.26.5 双构建，本地回执为 `82b18d6040bcd6be72cf170fa066ecd7cf469a53f4901365f379bec5a89c496d`。包装器在联网前核对全部本地事实，只允许一次固定 SSH 和一次原子 SFTP 暂存，改用 POSIX 参数展开并对失败、超时、stderr 或额外输出零重试。功能/主干同步 HEAD `3d3e6c430c552a67678e3743b5967218dfc87567` 的 CI run `31590161838` 为 12/12 SUCCESS，独立代码安全、QA 和产品/规格增量复验均为 P0=0、P1=0；最终文档 HEAD 的 required 门禁与增量复签仍须在合并前按 GitHub 实时结果核对。用户安装授权仍未取得，不得连接、上传或安装，测试服 P1 与 UNKNOWN 均未关闭。
