...
- 010 改用用户批准的 Drop 直连方案：显式使用现有 ED25519 私钥、固定 known_hosts、`IdentitiesOnly` 与 `ConnectionAttempts=1`，不复制或修改 Windows 私钥 ACL；候选冻结为 `CHG-G8-TEST-READONLY-ACCESS-DROP-20260813-010`、来源 `75b1fc4ddb7138495547cec03fa948648de337d7`、源码树 `53ba990318bc1a036b442d88ff8133d776a453dc`、Windows 回执 `3ff8cf3ad7237f866f83305d00ab73f766381b7f3247abee915efee629e41fb0`。PR #362 精确 HEAD `b47e94780a2ac884a7d2dccb0d1f80abb8b137cd` 的 CI run `31673893162` 为 12/12 SUCCESS，独立代码安全、QA、产品/规格均为 P0/P1/P2=0，并按 merge commit `a890cdff2793a141f7b377aa74d0996d57e13cbd` 合入主干。安装清单状态已收敛为 `PENDING_USER_APPROVAL`；尚未运行 010 本地检查、SSH、SFTP、root 安装或 sudo self-test，仓库合并不构成测试服安装授权。
