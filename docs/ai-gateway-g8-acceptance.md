...
- `CHG-G8-TEST-READONLY-STAGING-EVIDENCE-20260812-006` 仓库候选已通过 PR #345 精确 HEAD `2d55021d5497528303d69cb1e01b8feaf5098cad`、CI run `31609801571` 12/12、独立代码安全/QA/产品 P0/P1/P2=0，并以 merge commit `df7d64102f7a358b6109d39d05bbbe92c00302d9` 合入主干。候选复用并冻结 004 的 inode/fd/最终目录项竞态安全读取算法，把早期失败细分为固定门禁枚举；当前未执行 006，状态为 `PENDING_USER_APPROVAL`，不得把工程合并当作暂存 UNKNOWN 已关闭或远端执行授权。
