...
| SMS-P5-09 | 回滚 Dry Run 与恢复点 | 先关开关、保留证据、默认不 down migration；固定备份可验证且无外部副作用 | 本地 test/production 两套通过；测试服 11 文件、清单、权限、新旧哈希、架构和 health/ready 只读预检通过；应用实际回滚演练待独立授权 |
