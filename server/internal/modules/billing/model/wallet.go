...
type Wallet struct {
	...
	BalanceAmount decimal.Decimal `gorm:"type:decimal(20,8);not null;default:0" json:"balance_amount"`
	FrozenAmount  decimal.Decimal `gorm:"type:decimal(20,8);not null;default:0" json:"frozen_amount"`
...
type WalletTransaction struct {
	...
	BalanceAfter   decimal.Decimal `gorm:"type:decimal(20,8);not null" json:"balance_after"` // 交易后余额快照
